...
# Load the .env file
#tst = load_dotenv(f"{os.path.abspath(os.path.dirname(__file__))}/.env")
tst = load_dotenv(os.path.join(os.path.dirname(os.path.realpath(__file__)), ".env"))
assert tst, "env not loaded."
